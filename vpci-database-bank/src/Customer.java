...
public class Customer {
	 ...
	 * @param sin
	 ********************************************/
	public static void displayCustomerSummary (String firstName, String lastName, int sin) {
		...
		try {
			...
			int indexOfSin = list.indexOf(Integer.toString(sin));
			int indexOfCustomerStart = list.indexOf(lastName.toUpperCase());

			// Check if credentials exist 
			if (indexOfSin != -1 && (list.indexOf(firstName.toUpperCase())!=-1) && (list.indexOf(lastName.toUpperCase())!=-1)) {
				if (list.get(indexOfSin-1).equalsIgnoreCase(firstName)&&list.get(indexOfSin-2).equalsIgnoreCase(lastName)) {

					System.out.println("\nCUSTOMER SUMMARY FOR: " + firstName.toUpperCase() + " " + lastName.toUpperCase());
					System.out.println("--------");
